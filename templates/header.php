...
<link rel="stylesheet" href="<?= base('/assets/dataTables/css/dataTables.bootstrap.css'); ?>">
	...
	<nav class="navbar navbar-default navbar-fixed-top">
	    <div class="container">
	      <div class="navbar-header">
	        <a href="" class="navbar-brand"><img src="<?= base('/images/main-logo2.png'); ?>" width="200px" alt="" class="img img-responsive"></a>
