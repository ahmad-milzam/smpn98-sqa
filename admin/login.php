...
<html>
  ...
  <link rel="stylesheet" href="../assets/dataTables/css/dataTables.bootstrap.css" type="text/css">
  <link rel="shrotcut icon" href="images/favicon.png">
    ...
    <div class="container">
      <div class="col-md-4 col-md-offset-4 login" id="box-login" style="padding-bottom:none !important;">
        ...
        <div class="footer" style="border:none;background: none !important;color:#fff;">
          Copyright &copy; <?= date('Y'); ?> :: SMPN 98 Jakarta
        </div>
