          ...
          <div class="collapse navbar-collapse navbar-left">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown data-mapel">
                <a class="dropdown-toggle" id="dropdown" data-toggle="dropdown" href="admin/mata-pelajaran" role="button" aria-haspopup="true" aria-expanded="false">Mata Pelajaran <span class="caret"></span></a>
                <ul class="dropdown-menu menu-mapel">
                  <li><a href="<?= base('admin/mata-pelajaran'); ?>">Data Mapel</a></li>
              ...
              <li><a href="<?= base('admin/artikel'); ?>">Artikel</a></li>
